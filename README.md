...
This konnector retrieves your data and bills from Helloasso
...
The lead maintainers for this konnector is [@CPatchane](https://github.com/cpatchane)
...
Helloasso (konnector) is developed by Cozy Cloud and distributed under the [AGPL v3 license][agpl-3.0].
